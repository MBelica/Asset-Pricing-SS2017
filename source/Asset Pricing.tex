...
\begin{itemize}
	\item Bewertungstheorie zur Erklärung der Preisbildung
	\item Schlussfolgerungen, falls Vorhersagen der Theorie $\neq$ Beobachtung
\end{itemize}

\textbf{Anpassung der Theorie erforderlich:} Positive Theorie ~\\
\textbf{Fehlbewertung am Markt} $\Rightarrow$ \text{Handelsstrategie:} Normative Theorie ~\bigskip
...
\subsubsection{Asset Pricing Theorie}
\begin{itemize}
	\item zur Begründung, wie hoch fairer Preis sein sollte
...
\begin{enumerate}[label=\arabic*\upshape.]
	\item \textbf{Primat der Zahlungen} Für eine Entscheidung sind allein Zahlung (oder Zahlungsäquivalente) relevant.
